...
- [云原生应用 -动手实验前的准备](https://github.com/Azure/OCPCHINATECH/blob/master/OCPPTSCSAHandsonLabs/MCW-Cloud-native-applications/Hands-on%20lab/云原生应用 -动手实验前的准备.md)
&emsp;
&emsp;
- [云原生应用 -基础架构版本实验](https://github.com/Azure/OCPCHINATECH/blob/master/OCPPTSCSAHandsonLabs/MCW-Cloud-native-applications/Hands-on%20lab/云原生应用 -基础架构版本实验.md)  
  * 练习1：创建并运行Docker应用程序
...
- [云原生应用 -开发者版本实验](https://github.com/Azure/OCPCHINATECH/blob/master/OCPPTSCSAHandsonLabs/MCW-Cloud-native-applications/Hands-on%20lab/云原生应用 -开发者版本实验.md)
  * 练习1：创建并运行Docker应用程序
  * 练习2：使用Azure数据库迁移服务将MongoDB迁移到Cosmos DB
  * 练习3：将解决方案部署到Azure Kubernetes服务
  * 练习4：扩展应用程序并测试HA
